...
const handleYesClick = () => {
  question.innerHTML = "Yeahhhhhhhhhhh! Love you too!!";
  gif.src = "https://www.icegif.com/wp-content/uploads/2024/03/kuromi-icegif-1.gif";
  ...
  const dateIdeas = [
    "lets go kill skeletons in minecraft",
